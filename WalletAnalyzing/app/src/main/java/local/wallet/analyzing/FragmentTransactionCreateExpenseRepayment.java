 ...
 */
public class FragmentTransactionCreateExpenseRepayment extends Fragment implements  View.OnClickListener, FragmentTransactionCreateHost.OnSetupData {
    public static final String Tag = "TransactionCreateExpenseRepayment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        LogUtils.logEnterFunction(Tag, null);
        LogUtils.logLeaveFunction(Tag, null, null);
        return inflater.inflate(R.layout.layout_fragment_transaction_create_expense_repayment, container, false);
    }
    ...
    private void initView() {
        ...
        llLender        = (LinearLayout) getView().findViewById(R.id.llLender);
        llLender.setOnClickListener(this);
        tvLender        = (TextView) getView().findViewById(R.id.tvLender);
    ...
    private void startFragmentSelectCategory(TransactionEnum transactionType, int oldCategoryId) {
        ...
        FragmentTransactionCreateExpenseRepayment.this.getFragmentManager().beginTransaction()
